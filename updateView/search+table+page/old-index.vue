  ...
  <div class="app-container">
    <el-form ref="queryForm" class="queryCondition" size="small" label-width="100px" :inline="true" :model="queryParams">
      ...
      <el-form-item label="参数类型" prop="category">
        <el-select v-model="queryParams.category" filterable clearable placeholder="请选择">
      ...
      <el-form-item label="参数等级" prop="variety">
        <el-select v-model="queryParams.variety" filterable clearable placeholder="请选择">
      ...
      <el-form-item label="部门" prop="dept">
        <select-mes-dept v-model="queryParams.dept" :select-factory="this.queryParams.factoryParams"></select-mes-dept>
      </el-form-item>

      <el-form-item label="产品族" prop="productFamily">
        <el-select v-model="queryParams.productFamily" filterable clearable placeholder="请选择">
      ...
      <!-- <el-form-item label="触发类型" prop="triggerType">
        <el-select v-model="queryParams.triggerType" filterable clearable placeholder="请选择">
      ...
      <el-form-item label="等级" prop="level">
        <el-select v-model="queryParams.level" filterable clearable placeholder="请选择">
      ...
      <el-form-item label="流程状态" prop="triggerTypeList">
        <el-select v-model="queryParams.triggerStatus"  clearable filterable collapse-tags placeholder="请选择">
