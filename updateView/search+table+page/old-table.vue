<template>
  <div class="app-body">
    ...
    >
      ...
      <el-table-column prop="pn" label="产品型号" min-width="88">
      </el-table-column>
      <el-table-column prop="lotNo" label="批次号" min-width="80">
      </el-table-column>
      <el-table-column prop="productCategory" label="产品族" min-width="40">
      </el-table-column>
      <el-table-column prop="spcItemName" label="管制项目名称" min-width="140">
      </el-table-column>
      <el-table-column prop="category" label="参数类型" min-width="40">
      </el-table-column>
      <el-table-column prop="variety" label="种类" min-width="40">
      </el-table-column>
      ...
      <el-table-column prop="ocapStatus" label="OCAP状态" min-width="53">
      </el-table-column>
      ...
      <el-table-column prop="isCcb" label="是否变更批次" min-width="32">
      </el-table-column>
      <el-table-column
        prop="triggerTime"
        label="触发(工厂级/部门级)时间"
      ...
      <el-table-column prop="orderType1" label="订单类型" min-width="38">
      </el-table-column>
